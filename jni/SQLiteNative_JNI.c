/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Sun Aug 16 08:24:13 CEST 2015 ----! */
 ...
 *    Java method: int sqlc_db_changes(long db)
 *     C function: int sqlc_db_changes(sqlc_handle_t db);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1db_1changes__J(JNIEnv *env, jclass _unused, jlong db) {
  int _res;
  _res = sqlc_db_changes((sqlc_handle_t) db);
  return _res;
}
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_query_fill_window(long st, int w, int startPos, int offsetParam, int maxRead, int lastPos)
 *     C function: int sqlc_query_fill_window(sqlc_handle_t st, int w, int startPos, int offsetParam, int maxRead, int lastPos);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1query_1fill_1window__JIIIII(JNIEnv *env, jclass _unused, jlong st, jint w, jint startPos, jint offsetParam, jint maxRead, jint lastPos) {
  int _res;
  _res = sqlc_query_fill_window((sqlc_handle_t) st, (int) w, (int) startPos, (int) offsetParam, (int) maxRead, (int) lastPos);
  return _res;
}
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_bind_parameter_count(long st)
 *     C function: int sqlc_st_bind_parameter_count(sqlc_handle_t st);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1bind_1parameter_1count__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
  _res = sqlc_st_bind_parameter_count((sqlc_handle_t) st);
  return _res;
}
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_clear_bindings(long st)
 *     C function: int sqlc_st_clear_bindings(sqlc_handle_t st);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1clear_1bindings__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
  _res = sqlc_st_clear_bindings((sqlc_handle_t) st);
  return _res;
}
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_reset(long st)
 *     C function: int sqlc_st_reset(sqlc_handle_t st);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1reset__J(JNIEnv *env, jclass _unused, jlong st) {
  int _res;
  _res = sqlc_st_reset((sqlc_handle_t) st);
  return _res;
}
